# -*- coding: utf-8 -*-
from SI_model_DSIL_model import SI_model_DSIL_model
...
class SI_model(SI_model_base):
    ...
    def fit(self,X_train,C_train,SI_train):
        ...
        return SI_model_DSIL_model.fit(self,X_train,C_train,SI_train,model)
    ...
    def predict(self,X_test,C_test,SI_test): 
        ...
        """
        return SI_model_DSIL_model.predict(self,X_test, C_test, SI_test)